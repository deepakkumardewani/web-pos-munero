        ...
        <v-row justify="center" align="center">
          <v-col cols="12">
            <div class="tw-my-3 text-center">
              ...
              >
                <template #label>
                  <span class="tw-text-red-500"><strong>* </strong></span>Amount
                </template>
              </v-text-field>
            </div>
            <div class="text-center">
              <v-chip class="tw-mx-2" @click="addAmount('10')">$10</v-chip>
              <v-chip class="tw-mx-2" @click="addAmount('20')">$20</v-chip>
              <v-chip class="tw-mx-2" @click="addAmount('50')">$50</v-chip>
              <v-chip class="tw-mx-2" @click="addAmount('100')">$100</v-chip>
              <v-chip class="tw-mx-2" @click="addAmount('500')">$500</v-chip>
              <v-chip class="tw-mx-2" @click="addAmount('1000')">$1000</v-chip>
            </div>
